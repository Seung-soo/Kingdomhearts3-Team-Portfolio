#include "stdafx.h"
#include "..\public\UI_InvenNum.h"
#include "GameInstance.h"
#include "UI_Num_Manager.h"
#include "InvenManager.h"

CUI_InvenNum::CUI_InvenNum(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	:CUI_Parents(pDevice, pDeviceContext)
{
}

CUI_InvenNum::CUI_InvenNum(const CUI_InvenNum & rhs)
	: CUI_Parents(rhs)
{
}

HRESULT CUI_InvenNum::NativeConstruct_Prototype()
{
...
HRESULT CUI_InvenNum::NativeConstruct(void * pArg)
{
	...
	_float pointX = (*(FONT_SET*)pArg).Set_X;
	_float pointY = (*(FONT_SET*)pArg).Set_Y;
...
_int CUI_InvenNum::Tick(_double TimeDelta)
{
...
_int CUI_InvenNum::LateTick(_double TimeDelta)
{
...
HRESULT CUI_InvenNum::Render()
{
	...
	if (true == Inven->Get_InvenNumRender())
...
HRESULT CUI_InvenNum::SetUp_Components()
{
	/* For.Com_Renderer */
...
HRESULT CUI_InvenNum::SetUp_ConstantTable()
{
...
CUI_InvenNum * CUI_InvenNum::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CUI_InvenNum*	pInstance = new CUI_InvenNum(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created CUI_InvenNum");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CUI_InvenNum::Clone(void * pArg)
{
	CUI_InvenNum*	pInstance = new CUI_InvenNum(*this);
