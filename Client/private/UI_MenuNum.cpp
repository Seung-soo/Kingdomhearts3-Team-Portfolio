#include "stdafx.h"
#include "..\public\UI_MenuNum.h"
#include "GameInstance.h"
#include "UI_Num_Manager.h"

CUI_MenuNum::CUI_MenuNum(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	:CUI_Parents(pDevice, pDeviceContext)
{
}

CUI_MenuNum::CUI_MenuNum(const CUI_MenuNum & rhs)
	: CUI_Parents(rhs)
{
}

HRESULT CUI_MenuNum::NativeConstruct_Prototype()
{
...
HRESULT CUI_MenuNum::NativeConstruct(void * pArg)
{
...
_int CUI_MenuNum::Tick(_double TimeDelta)
{
...
_int CUI_MenuNum::LateTick(_double TimeDelta)
{
...
HRESULT CUI_MenuNum::SetUp_Components()
{
	/* For.Com_Renderer */
...
HRESULT CUI_MenuNum::SetUp_ConstantTable()
{
...
CUI_MenuNum * CUI_MenuNum::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CUI_MenuNum*	pInstance = new CUI_MenuNum(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created CUI_Number");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CUI_MenuNum::Clone(void * pArg)
{
	CUI_MenuNum*	pInstance = new CUI_MenuNum(*this);

	if (FAILED(pInstance->NativeConstruct(pArg)))
	{
		MSGBOX("Failed to Created CUI_MenuNum");
		Safe_Release(pInstance);
	}
	return pInstance;
}

void CUI_MenuNum::Free()
{
	__super::Free();
