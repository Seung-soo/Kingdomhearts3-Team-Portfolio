...
CUI_Number::CUI_Number(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
...
HRESULT CUI_Number::NativeConstruct_Prototype()
{
...
HRESULT CUI_Number::NativeConstruct(void * pArg)
{
...
_int CUI_Number::Tick(_double TimeDelta)
{
...
_int CUI_Number::LateTick(_double TimeDelta)
{
...
HRESULT CUI_Number::SetUp_Components()
{
	/* For.Com_Renderer */
...
HRESULT CUI_Number::SetUp_ConstantTable()
{
...
CUI_Number * CUI_Number::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CUI_Number*	pInstance = new CUI_Number(pDevice, pDeviceContext);
