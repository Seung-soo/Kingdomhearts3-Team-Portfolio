...
class CCrowSoldier final : public CMonster
{
private:
	CCrowSoldier(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	CCrowSoldier(const CCrowSoldier& rhs);
	virtual ~CCrowSoldier() = default;
...
public:
	static	CCrowSoldier* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
