...
//   - outer_size.y  = 0.0f  ->  Bottom-align, consistent with BeginChild(). Not reCommanded unless table is last item in parent window.
//   - outer_size.y  > 0.0f  ->  Set Exact height. ReCommanded when using Scrolling on any axis.
//-----------------------------------------------------------------------------
...
// - For large numbers of rows, it is reCommanded you use ImGuiListClipper to only submit visible rows.
