...
class CBowMan final : public CMonster
{
private:
	CBowMan(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	CBowMan(const CBowMan& rhs);
	virtual ~CBowMan() = default;
...
public:
	static	CBowMan* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
