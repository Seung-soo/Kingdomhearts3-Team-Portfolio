#include "stdafx.h"
#include "..\public\UI_BossHPCntBack.h"
...
CUI_BossHPCntBack::CUI_BossHPCntBack(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	:CUI_Parents(pDevice, pDeviceContext)
{
}

CUI_BossHPCntBack::CUI_BossHPCntBack(const CUI_BossHPCntBack & rhs)
	: CUI_Parents(rhs)
{
}

HRESULT CUI_BossHPCntBack::NativeConstruct_Prototype()
{
...
HRESULT CUI_BossHPCntBack::NativeConstruct(void * pArg)
{
...
_int CUI_BossHPCntBack::Tick(_double TimeDelta)
{
	if (true == m_bDead)
		return RESULT_DEAD;
...
_int CUI_BossHPCntBack::LateTick(_double TimeDelta)
{
...
HRESULT CUI_BossHPCntBack::Render()
{
	if (false == GM->Get_UIRender())
		return S_OK;
...
HRESULT CUI_BossHPCntBack::SetUp_Components()
{
	/* For.Com_Renderer */
...
HRESULT CUI_BossHPCntBack::SetUp_ConstantTable()
{
...
CUI_BossHPCntBack * CUI_BossHPCntBack::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CUI_BossHPCntBack*	pInstance = new CUI_BossHPCntBack(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created CUI_BossHPCntBack");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CUI_BossHPCntBack::Clone(void * pArg)
{
	CUI_BossHPCntBack*	pInstance = new CUI_BossHPCntBack(*this);
