...
class CCannon final : public CMonster
{
private:
	CCannon(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	CCannon(const CCannon& rhs);
...
public:
	static	CCannon* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
